CREATE PROCEDURE DBO.SP_MERGE_MIRROR_MSTBWD  
 ( @NMODE INT
  ,@XN_TYPE VARCHAR(50) ='MSTBWD'
  )
AS  
 BEGIN  
...
BEGIN TRY  
   ...
   BEGIN  
   SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTBWD, CANNOT CALL MERGING PROC AT HEAD OFFICE'  
   GOTO END_PROC  
     END       
  ...
  --INSERT DATA INTO LOCATION TABLE  
    ...
    SET @CSOURCETABLE ='MSTBWD_BWD_MST_MIRROR'  
    ...
    SET @CSOURCETABLE ='MSTBWD_BWD_DET_MIRROR'  
...
BEGIN CATCH  
 SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTBWD, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()  
 GOTO END_PROC  
END CATCH  
...
END_PROC:  
 ...
 BEGIN     
	 ...
	 DELETE FROM MSTBWD_BWD_DET_MIRROR
	 DELETE FROM MSTBWD_BWD_MST_MIRROR
...
--END PROCEDURE SP_MERGE_MIRROR_MSTBWD
