CREATE PROCEDURE SP_MERGE_MIRROR_SCHNEW_DATA
(
	@CMEMOID VARCHAR(50)
   ,@CLOCID VARCHAR(3)
...
BEGIN
    ...
    BEGIN TRY
		...
		BEGIN TRANSACTION
			...
			SET @CTMP_TABLENAME='TMP_SCHNEW_'+@CTABLENAME+'_'+LTRIM(RTRIM(@CTABLE_SUFFIX))
			...
			SET @CSTEP=350
			SET @CTABLESSTR='SCHEME_SETUP_SLSBC,SCHEME_SETUP_DET,SCHEME_SETUP_MST,XNSTABLELIST'
