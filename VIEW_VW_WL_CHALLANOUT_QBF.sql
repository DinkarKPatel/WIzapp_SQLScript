CREATE VIEW VW_WL_CHALLANOUT_QBF 
--WITH ENCRYPTION
AS     
SELECT 
 A.CHALLAN_ID AS 'CHALLAN_ID',
 A.CHALLAN_NO AS 'MST_CHALLAN_NO',
 A.CHALLAN_DT AS 'CHALLAN_DT',
 A.CHECKED_BY AS 'MST_CHECKED_BY',
 A.REMARKS AS 'MST_REMARKS',
 A.RECEIPT_DT AS 'RECEIPT_DT',
 A.DISCOUNT_AMOUNT AS 'MST_DISCOUNT_PERCENTAGE',
 ...
 E.MRP AS 'MRP',
 D.RATE AS 'RATE',
 --D.NET_RATE AS 'NET_RATE',
 D.TAX_STATUS AS 'TAX_STATUS',
...
JOIN COD01106 (NOLOCK) D ON A.CHALLAN_ID = D.CHALLAN_ID
...
--*********************************************** END OF VIEW VW_WL_CHALLANOUT_QBF
