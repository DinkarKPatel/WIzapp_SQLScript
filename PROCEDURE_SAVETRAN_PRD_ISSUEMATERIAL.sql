CREATE PROCEDURE SAVETRAN_PRD_ISSUEMATERIAL
(
...
BEGIN
	...
	SET @CDETAILTABLENAME1	= 'PRD_ISSUE_MATERIAL_DET'
	...
	BEGIN TRY
		...
		IF @NUPDATEMODE = 3
		BEGIN
			EXEC SAVETRAN_CANCELXN 'MIS',@CDETAILTABLENAME1,@CXNMEMOID,@CKEYFIELD1,@CMASTERTABLENAME,@CLOCATIONID,
...
END_PROC:
	...
	EXEC SP_DROPTEMPTABLES_XNS 'XNSMIS',@NSPID	
END			
------------------------------------------------------ END OF PROCEDURE SAVETRAN_PRD_ISSUEMATERIAL
