...
MST.DISCOUNT_PERCENTAGE AS MST_DISCOUNT_PERCENTAGE_CALC ,DTM.DT_NAME  AS MST_DT_NAME,
...
ART.BL_ARTICLE_NAME ,
GST.GST_STATE_NAME  AS MST_PARTY_STATE_NAME
...
JOIN LM01106 LM1 (NOLOCK) ON MST.AC_CODE=LM1.AC_CODE
LEFT OUTER JOIN FORM (NOLOCK) ON SKU.FORM_ID=FORM.FORM_ID
JOIN HD01106 HD (NOLOCK) ON LM.HEAD_CODE=HD.HEAD_CODE
JOIN COMPANY CMP (NOLOCK) ON HD.COMPANY_CODE=CMP.COMPANY_CODE
--JOIN LM01106 DLM (NOLOCK) ON FORM.EXCISE_DUTY_AC_CODE=DLM.AC_CODE
--JOIN LM01106 ELM (NOLOCK) ON FORM.EXCISE_EDU_CESS_AC_CODE=ELM.AC_CODE
--JOIN LM01106 HLM (NOLOCK) ON FORM.EXCISE_HEDU_CESS_AC_CODE=HLM.AC_CODE
--JOIN LM01106 PRLM (NOLOCK) ON FORM.PUR_RETURN_AC_CODE=PRLM.AC_CODE
--JOIN LM01106 SRLM (NOLOCK) ON FORM.SALE_RETURN_AC_CODE=SRLM.AC_CODE
--JOIN LM01106 PLM (NOLOCK) ON FORM.PURCHASE_AC_CODE=PLM.AC_CODE
--JOIN LM01106 SLM (NOLOCK) ON FORM.SALE_AC_CODE=SLM.AC_CODE
--JOIN LM01106 TLM (NOLOCK) ON FORM.TAX_AC_CODE=TLM.AC_CODE
...
LEFT OUTER JOIN GST_STATE_MST GST (NOLOCK) ON MST.PARTY_STATE_CODE=  GST.GST_STATE_CODE
LEFT OUTER JOIN
(
