CREATE PROC SPPR_CREATEONLINEPARA        
...
EXEC GETNEXTKEY @CTABLENAME='PARA1'             
       ,@CCOLNAME='PARA1_CODE'              
       ,@NWIDTH='7'              
       ,@CPREFIX='00'              
       ,@NLZEROS=1              
  ...
  INSERT PARA1(PARA1_CODE, PARA1_NAME,INACTIVE, LAST_UPDATE, ALIAS,  PARA1_ORDER, PARA1_SET, REMARKS, BL_PARA1_NAME, LAST_MODIFIED_ON)  
...
ELSE IF @PARATABLENAME='PARA2' BEGIN    
   
               
IF NOT EXISTS(SELECT * FROM PARA2 WHERE PARA2_NAME=@PARANAME)      
