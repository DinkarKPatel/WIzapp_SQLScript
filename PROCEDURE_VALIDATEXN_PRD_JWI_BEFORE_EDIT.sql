CREATE PROC VALIDATEXN_PRD_JWI_BEFORE_EDIT 
@CMEMOID VARCHAR(30),
@BCANCELXN BIT,
...
BEGIN
	...
	IF EXISTS (SELECT TOP 1 A.ISSUE_ID 
			   ...
			   JOIN PRD_JOBWORK_RECEIPT_DET D ON D.REF_ROW_ID=B.ROW_ID
			   JOIN PRD_JOBWORK_RECEIPT_MST E ON E.RECEIPT_ID=D.RECEIPT_ID
			   WHERE A.ISSUE_ID=@CMEMOID AND A.CANCELLED=0 AND E.CANCELLED=0 AND B.JOB_CODE=D.JOB_CODE )
	BEGIN	
		SET @CERRORMSG='ONE OR MORE REFERENCES OF THIS MEMO IS FOUND INTO PRD JOB RECEIPT.........CAN NOT '+@CTEXT
		RETURN
	END
