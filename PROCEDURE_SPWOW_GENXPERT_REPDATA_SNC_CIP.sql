CREATE PROCEDURE SPWOW_GENXPERT_REPDATA_SNC_CIP
...
BEGIN
	...
	SELECT @cBaseExpr='[LAYOUT_COLS]   from [DATABASE].dbo.snc_consumable_det snc_consumable_det (NOLOCK)       
	JOIN  [DATABASE].dbo.snc_mst snc_mst (NOLOCK) ON snc_consumable_det.memo_ID = snc_mst.memo_ID         
	join SKU_NAMES (NOLOCK) ON sku_names.product_code=snc_consumable_det.PRODUCT_CODE
	...
	JOIN bin SourceBin on SourceBin.bin_id=snc_consumable_det.bin_id
