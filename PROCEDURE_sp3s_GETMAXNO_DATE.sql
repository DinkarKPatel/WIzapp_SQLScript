...
CREATE procedure sp3s_GETMAXNO_DATE 
@DMEMODT DATETIME,
@NMEMOPREFIXLEN INT,
@CMEMOPREFIX VARCHAR(10),
@CFINYEAR VARCHAR(10),
@CXNID VARCHAR(40),
@cMaxBillNo varchar(20) OUTPUT


AS
BEGIN
	print 'sp3s_GETMAXNO_DATE step#1'
	DECLARE @DPREVMEMODT DATETIME
	
	print 'sp3s_GETMAXNO_DATE step#2'
	...
	BEGIN
		print 'sp3s_GETMAXNO_DATE step#3'
		...
		print 'sp3s_GETMAXNO_DATE step#4'
		SELECT @CMAXBILLNO=MAX(CM_NO) FROM CMM01106 (NOLOCK) 
