CREATE PROCEDURE SAVETRAN_MREC_PRD
(
...
BEGIN
	...
	BEGIN TRY
		...
		SET @CTEMPDETAILTABLENAME	= 'TEMP_PRD_MATERIAL_RECEIPT_DET_'+LTRIM(RTRIM(STR(@NSPID)))					
		...
		BEGIN
			...
			SET @CCMD = N'UPDATE PRD_MATERIAL_RECEIPT_MST SET CANCELLED = 1,LAST_UPDATE=GETDATE() ' + 
		...
		SET @CMASTERTABLENAME	= 'PRD_MATERIAL_RECEIPT_MST'
		SET @CDETAILTABLENAME	= 'PRD_MATERIAL_RECEIPT_DET'

		SET @CTEMPMASTERTABLENAME	= 'TEMP_PRD_MATERIAL_RECEIPT_MST_'+LTRIM(RTRIM(STR(@NSPID)))
...
END
------------------------------------------------------ END OF PROCEDURE SAVETRAN_MREC
