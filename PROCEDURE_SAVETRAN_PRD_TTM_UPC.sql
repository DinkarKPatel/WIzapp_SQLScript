CREATE PROCEDURE SAVETRAN_PRD_TTM_UPC
(
...
BEGIN
	...
	SET @CDETAILTABLENAME1	= 'PRD_TRANSFER_TO_TRADING_UPC'
	...
	SET @NSTEP = 10		-- GETTING DEPTID INFO FROM TEMP TABLE
		...
		BEGIN
	       ...
	       IF EXISTS (SELECT TOP 1 'U' FROM PRD_UPCPMT A
		    JOIN PRD_TRANSFER_TO_TRADING_UPC B ON A.PRODUCT_CODE=B.PRODUCT_CODE WHERE B.MEMO_ID=@CMEMO_ID AND QUANTITY_IN_STOCK <0)
		    BEGIN
...
END			
-------- END OF PROCEDURE SAVETRAN_PRD_TTM_UPC
