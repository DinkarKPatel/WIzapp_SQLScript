CREATE PROCEDURE SP_RPT_EXCISEREPORT2 --(LocId 3 digit change  by Sanjay:01-11-2024)
(
@FROMDT DATETIME,      
@TODT  DATETIME  
) 
...
BEGIN
       ...
       DECLARE @CCMD NVARCHAR(MAX),@CFILTER NVARCHAR(MAX),@CLOCID VARCHAR(4),@HO_LOC_ID VARCHAR(4)
   ...
   SET @CCMD=N'SELECT [SUB_SECTION_NAME],MRP AS [CAL_MRP],
