CREATE PROCEDURE SP_MERGE_MIRROR_DNPS_DATA
(
	@CMEMOID VARCHAR(50)
   ,@CLOCID VARCHAR(3)
...
BEGIN TRY
	...
	SET @CTMP_TABLENAME='TMP_DNPS_'+@CTABLENAME+'_'+LTRIM(RTRIM(@CTABLE_SUFFIX))
	SET @CKEYFIELD='PS_ID'
	SET @CSTEP=90
	...
	SET @CTMP_TABLENAME=@CSOURCEDB+'TMP_DNPS_pmt01106_'+LTRIM(RTRIM(@CTABLE_SUFFIX))
	EXEC SP3S_MERGE_LOCPMT  
	@cTempTable=@CTMP_TABLENAME
		
	SET @CSTEP=260
	SET @CTABLESSTR='DNPS_MST,DNPS_DET,LM01106,LMP01106,HD01106,AREA,CITY,STATE,XNSTABLELIST'
...
END TRY
BEGIN CATCH
	SET @CERRMSG='P:SP_MERGE_MIRROR_DNPS_DATA, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()
END CATCH
EXIT_PROC:
