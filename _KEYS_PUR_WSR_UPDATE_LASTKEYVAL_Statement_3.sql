IF NOT EXISTS(SELECT TOP 1 'U' FROM CONFIG WHERE CONFIG_OPTION ='KEYS_INM_UPDATE_LASTKEYVAL' AND VALUE =1)
BEGIN

   UPDATE  KEYS_INM SET PREFIX=PREFIX +'-' WHERE RIGHT(PREFIX,1)<>'-'
 ...
 FROM KEYS_INM  A 
  ...
  SELECT 	  CONFIG_OPTION='KEYS_INM_UPDATE_LASTKEYVAL', VALUE=1, ROW_ID=NEWID(), 
