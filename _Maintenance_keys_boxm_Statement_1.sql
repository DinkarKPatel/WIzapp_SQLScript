IF NOT EXISTS(SELECT TOP 1 'U' FROM CONFIG WHERE CONFIG_OPTION ='UPDATE_KEYS_BOXM' AND VALUE =1)
BEGIN
 UPDATE A SET
 LASTKEYVAL=  
 ...
 FROM KEYS  A 
 WHERE TABLENAME ='BOXM' 
 
  INSERT CONFIG	( CONFIG_OPTION, VALUE, ROW_ID, LAST_UPDATE,  REMARKS )  
  SELECT 	   CONFIG_OPTION='UPDATE_KEYS_BOXM', VALUE=1, ROW_ID=NEWID(), LAST_UPDATE=GETDATE (), REMARKS =''
