CREATE PROCEDURE SAVETRAN_PRD_AGENCY_ISSUEMATERIAL_PENDING
(
...
BEGIN
	...
	ELSE
		SET @CTEMPDBNAME = ''
	SET @CMASTERTABLENAME	= 'PRD_AGENCY_ISSUE_MATERIAL_MST_PENDING'
	SET @CDETAILTABLENAME1	= 'PRD_AGENCY_ISSUE_MATERIAL_DET_PENDING'
	...
	BEGIN TRY
		...
		BEGIN
		   ...
		   SET @NSTEP=1000
		  IF EXISTS(  SELECT TOP 1 'U' FROM PRD_AGENCY_ISSUE_MATERIAL_DET_PENDING A
			...
			EXEC SAVETRAN_CANCELXN 'AMIS_PEN',@CDETAILTABLENAME1,@CXNMEMOID,@CKEYFIELD1,@CMASTERTABLENAME,@CLOCATIONID,
