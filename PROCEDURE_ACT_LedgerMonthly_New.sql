create PROCEDURE ACT_LEDGERMONTHLY_NEW 
(	
		@CACCODE VARCHAR(20) = '', 
		@CDEPTID VARCHAR(4), 
		@DOPENINGDT DATETIME, 
...
BEGIN
	...
	DECLARE @CTMPACCODE VARCHAR(20), 
			...
			@NAVGTRAN NUMERIC(14,2),@CDONOT_CONSIDER_MEMO_VOUCHERS_ACCBOOKS VARCHAR(2),
	...
	BEGIN
		...
		SELECT @NOPENING = DBO.FN_ACT_OPENING_NEW ( @CTMPACCODE, @CDEPTID, @DOPENINGDT, @CFINYEAR, @CCOMPANYCODE )
		...
		(
				...
				WHERE (A.AC_CODE = @CTMPACCODE OR LM.MAJOR_AC_CODE=@CTMPACCODE)
				...
				AND (D.VOUCHER_CODE<>'MEMO000002' OR (@CCONSIDER_MEMO_REVERSAL_VOUCHERS_ACCBOOKS='1' AND @CDONOT_CONSIDER_MEMO_VOUCHERS_ACCBOOKS<>'1'))					
