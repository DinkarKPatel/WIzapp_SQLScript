CREATE PROCEDURE USP_GP_RETURN_NAVIGATE
(
...
BEGIN 
          ...
          SET @CCMD=N'SELECT  MEMO_NO,MEMO_ID,MEMO_DT,TRANSPORTER_NAME,TRANSPORTER_CODE,
               ...
               ,RECEIVED_FROM,ISSUE_MEMO_NO,ISSUE_MEMO_ID
                FROM(
                SELECT  N.MEMO_NO,N.MEMO_ID,N.MEMO_DT,ANGM.ANGADIA_NAME AS TRANSPORTER_NAME,N.TRANSPORTER_CODE,
				...
				,N.RECEIVED_FROM,P.MEMO_NO AS ISSUE_MEMO_NO,ISSUE_MEMO_ID
				FROM TBL_GP_RETURN_MST N (NOLOCK)
				JOIN TBL_GP_ISSUE_MST P(NOLOCK) ON N.ISSUE_MEMO_ID=P.MEMO_ID
          ...
          EXEC SP_EXECUTESQL @CCMD
            ...
            SET @CCMD=N'SELECT CHK, INV_NO,AC_NAME,INV_ID,INV_DT,
					QUANTITY,
					[WEIGHT],TOTAL_BOXES,REMARKS_DET,RECEIVED_FROM
                FROM (
				...
				JOIN INM01106 D(NOLOCK) ON b.REF_MEMO_ID=D.INV_ID
				JOIN IND01106 E(NOLOCK) ON E.INV_ID=D.INV_ID
				JOIN LM01106 L(NOLOCK) ON L.AC_CODE=D.AC_CODE
				JOIN TBL_GP_RETURN_DET M (NOLOCK) ON M.INV_ID=D.INV_ID
				JOIN TBL_GP_RETURN_MST N (NOLOCK) ON M.MEMO_ID=N.MEMO_ID
				...
				,AGM.ANGADIA_NAME,N.RECEIVED_FROM
