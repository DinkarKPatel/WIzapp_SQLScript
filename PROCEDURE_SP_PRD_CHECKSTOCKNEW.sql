CREATE PROCEDURE SP_PRD_CHECKSTOCKNEW  
(       
...
BEGIN        
 ...
 ELSE            
 BEGIN      
  SELECT @NSTKQTY = QUANTITY_IN_STOCK FROM PRD_PMT WHERE  PRODUCT_CODE=@CPRDCODE AND DEPARTMENT_ID=@CDEPT_ID  AND QUANTITY_IN_STOCK>0        
