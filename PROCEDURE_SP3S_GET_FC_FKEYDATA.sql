CREATE PROCEDURE SP3S_GET_FC_FKEYDATA
...
BEGIN
	BEGIN TRY
		...
		SET @CFILTERCONDITION= 'B.FC_CODE IN (SELECT '+@CSOURCEKEYFIELD+' FROM '+@CTEMPTABLE+' )'
	...
	BEGIN CATCH
		SELECT @CERRORMSG='PROCEDURE SP3S_GET_FC_FKEYDATA : '+ISNULL(ERROR_PROCEDURE(),'NULL P')+'STEP :'+STR(ISNULL(@NSTEP,0))+ ' LINE NO. :'+
...
END
----'END OF PROCEDURE SP3S_GET_FC_FKEYDATA'
