CREATE VIEW  VW_JOBWORKRECEIVE_QBF   
...
AS  
 ...
 M.AGENCY_NAME AS MST_AGENCY_NAME,C.REF_NO AS ISSUE_REF_NO,D.NON_RECEIVABLE ,A.REMARKS AS DET_REMARKS 
 FROM JOBWORK_RECEIPT_MST B (NOLOCK)  
 JOIN JOBWORK_RECEIPT_DET A (NOLOCK) ON B.RECEIPT_ID = A.RECEIPT_ID     
