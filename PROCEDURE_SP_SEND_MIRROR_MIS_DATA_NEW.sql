CREATE PROCEDURE SP_SEND_MIRROR_MIS_DATA_NEW  
(  
...
LBLTABLEINFO:  
 ...
 SET @CSTEP=66  
 SELECT DISTINCT 'MIS_PMT01106_MIRROR' AS TARGET_TABLENAME,A.DEPT_ID,A.product_code,A.BIN_ID,A.quantity_in_stock,
...
END TRY  
BEGIN CATCH  
 SET @CERRMSG='P: SP_SEND_MIRROR_MIS_DATA_NEW, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()  
 GOTO END_PROC  
END CATCH   
...
END   
---END OF PROCEDURE - SP_SEND_MIRROR_MIS_DATA_NEW  