CREATE PROCEDURE DBO.SP_MERGE_MIRROR_MSTANGM
 @NMODE INT
,@XN_TYPE VARCHAR(50) ='MSTANGM'
AS
 BEGIN
...
BEGIN TRY
	...
	BEGIN TRANSACTION
	  ...
	  BEGIN
			SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTANGM, CANNOT CALL MERGING PROC AT HEAD OFFICE'
			GOTO END_PROC
  	  END					
	  ...
	  SET @CTEMPTABLE='MSTANGM_LM01106_MIRROR'
	  ...
	  SET @CTEMPTABLE='MSTANGM_LMP01106_MIRROR'
	  IF OBJECT_ID(@CTEMPTABLE,'U') IS NOT NULL  
	  BEGIN
			SET @DTSQL=N'UPDATE '+@CTEMPTABLE+'  WITH (ROWLOCK) SET COMPANY_CODE=''01'''
			EXEC SP_EXECUTESQL @DTSQL
	 ...
	 --INSERT DATA INTO LOCATION TABLE
	   ...
	   SET @CSOURCETABLE ='MSTANGM_REGIONM_MIRROR'
	   ...
	   SET @CSOURCETABLE ='MSTANGM_STATE_MIRROR'
	   ...
	   SET @CSTEP = 60
	   SET @CTABLENAME = 'CITY'
	   SET @CSOURCETABLE ='MSTANGM_CITY_MIRROR'
	   ...
	   SET @CSTEP = 70
	   SET @CTABLENAME = 'AREA'
	   SET @CSOURCETABLE ='MSTANGM_AREA_MIRROR'
	   ...
	   SET @CSOURCETABLE ='MSTANGM_HD01106_MIRROR'
	   ...
	   SET @CSOURCETABLE ='MSTANGM_LM01106_MIRROR'
	   ...
	   SET @CSOURCETABLE ='MSTANGM_LMP01106_MIRROR'
	   SET @CKEYFIELD1='AC_CODE'
	   EXEC UPDATEMASTERXN
	   @CSOURCEDB=@CSOURCEDB, @CSOURCETABLE=@CSOURCETABLE,
	   @CDESTDB='',@CDESTTABLE=@CTABLENAME,@CKEYFIELD1=@CKEYFIELD1,
	   ...
	   SET @CSTEP = 110
	   SET @CTABLENAME = 'ANGM'
	   SET @CSOURCETABLE ='MSTANGM_ANGM_MIRROR'
	   SET @CKEYFIELD1 ='ANGADIA_CODE'
	   EXEC UPDATEMASTERXN
	   @CSOURCEDB=@CSOURCEDB, @CSOURCETABLE=@CSOURCETABLE,
	   @CDESTDB='',@CDESTTABLE=@CTABLENAME,@CKEYFIELD1=@CKEYFIELD1,
	   @CKEYFIELD2=@CKEYFIELD2,@CKEYFIELD3=@CKEYFIELD3,@LINSERTONLY=0,
...
BEGIN CATCH
	SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTANGM, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()
	GOTO END_PROC
END CATCH
...
END_PROC:
	...
	BEGIN   
		  ...
		  DELETE FROM MSTANGM_ANGM_MIRROR
		  DELETE FROM MSTANGM_LM01106_MIRROR
		  DELETE FROM MSTANGM_HD01106_MIRROR
		  DELETE FROM MSTANGM_LMP01106_MIRROR
		  DELETE FROM MSTANGM_AREA_MIRROR
		  DELETE FROM MSTANGM_CITY_MIRROR
		  DELETE FROM MSTANGM_STATE_MIRROR
		  DELETE FROM MSTANGM_REGIONM_MIRROR
...
END
--END PROCEDURE SP_MERGE_MIRROR_MSTANGM
