CREATE PROCEDURE DBO.SP_MERGE_MIRROR_MSTBGT  
  (@NMODE INT  
  ,@XN_TYPE VARCHAR(50) ='MSTBGT'  
  )  
AS  
 BEGIN  
...
BEGIN TRY  
   ...
   BEGIN  
   SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTBGT, CANNOT CALL MERGING PROC AT HEAD OFFICE'  
   GOTO END_PROC  
     END       
   ...
   --DELETE ALREADY EXISTING RECORDS FOR [MASTER TABLE 
     ...
     DELETE FROM  MONTHLYBUDGET_HEAD  
     
     
   SET @CSTEP = 20  
     
   SET @CTEMPTABLE='MSTBGT_LM01106_MIRROR'
   SET @DTSQL=N'UPDATE '+@CTEMPTABLE+' WITH (ROWLOCK)  SET COMPANY_CODE=''01'''  
   EXEC SP_EXECUTESQL @DTSQL  
  
   SET @CTEMPTABLE='MSTBGT_LMP01106_MIRROR'
  ...
  --INSERT DATA INTO LOCATION TABLE  
    ...
    SET @CSOURCETABLE ='MSTBGT_REGIONM_MIRROR'  
    ...
    SET @CSOURCETABLE ='MSTBGT_STATE_MIRROR'  
    ...
    SET @CSTEP = 60  
    SET @CTABLENAME = 'CITY'  
    SET @CSOURCETABLE ='MSTBGT_CITY_MIRROR'  
    ...
    SET @CSTEP = 70  
    SET @CTABLENAME = 'AREA'  
    SET @CSOURCETABLE ='MSTBGT_AREA_MIRROR'  
    ...
    SET @CSOURCETABLE ='MSTBGT_HD01106_MIRROR'  
    ...
    SET @CSOURCETABLE ='MSTBGT_LM01106_MIRROR'  
    ...
    SET @CSOURCETABLE ='MSTBGT_LMP01106_MIRROR'  
    SET @CKEYFIELD1='AC_CODE'  
    EXEC UPDATEMASTERXN  
    @CSOURCEDB=@CSOURCEDB, @CSOURCETABLE=@CSOURCETABLE,  
    @CDESTDB='',@CDESTTABLE=@CTABLENAME,@CKEYFIELD1=@CKEYFIELD1,  
    ...
    SET @CSOURCETABLE ='MSTBGT_MONTHLYBUDGET_HEAD_MIRROR'  
    ...
    SET @CSOURCETABLE ='MSTBGT_MONTHLYBUDGET_MIRROR'    
    SET @CKEYFIELD1='DEPT_ID'   
    SET @CKEYFIELD2 ='FIN_YEAR' 
...
BEGIN CATCH  
 SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTBGT, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()  
 GOTO END_PROC  
END CATCH  
...
END_PROC:  
 ...
 BEGIN     
  ...
  DELETE FROM MSTBGT_REGIONM_MIRROR
  DELETE FROM MSTBGT_STATE_MIRROR
  DELETE FROM MSTBGT_CITY_MIRROR
  DELETE FROM MSTBGT_AREA_MIRROR
  DELETE FROM MSTBGT_LMP01106_MIRROR
  DELETE FROM MSTBGT_LM01106_MIRROR
  DELETE FROM MSTBGT_MONTHLYBUDGET_HEAD_MIRROR
  DELETE FROM MSTBGT_HD01106_MIRROR
  DELETE FROM MSTBGT_MONTHLYBUDGET_MIRROR
...
END  
--END PROCEDURE SP_MERGE_MIRROR_MSTBGT
