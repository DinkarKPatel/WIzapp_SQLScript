...
create PROCEDURE SP3S_IMPORT_BUYER_ORDER_opt
(
...
BEGIN
    ...
    @CKEYFIELDVAL1 VARCHAR(100),@CLOCATIONID VARCHAR(2),@CAC_CODE VARCHAR(10),
...
--  SET @CCONTROL_AC_CODE='H112100403'
   ...
   SELECT  CAST('' AS VARCHAR(100)) AS SECTION_NAME,CAST('' AS VARCHAR(100)) AS SUB_SECTION_NAME,CAST('' AS VARCHAR(100)) AS ARTICLE_NO,
	 ...
	 CAST('' AS VARCHAR(40)) P1_SET,CAST('' AS VARCHAR(40)) P2_SET,CAST(0 AS BIT) AS PERISHABLE,
	  CAST('' AS VARCHAR(1000)) AS article_desc
	 ,CAST('' AS VARCHAR(1000)) AS VENDOR_EAN_NO,CAST('' AS VARCHAR(1000)) AS BATCH_NO,
	 CAST('' AS DATETIME) AS EXPIRY_DT,
	 CAST('' AS VARCHAR(100)) PARA1_ALIAS,
	 CAST('' AS VARCHAR(100)) PARA2_ALIAS,
	 CAST('' AS VARCHAR(100)) PARA3_ALIAS,
	 CAST('' AS VARCHAR(100)) PARA4_ALIAS,
	 CAST('' AS VARCHAR(100)) PARA5_ALIAS,
	 CAST('' AS VARCHAR(100)) PARA6_ALIAS,
	 CAST('' AS VARCHAR(100)) EAN_PREFIX,
	 CAST('' AS VARCHAR(100)) REPLACEABLE_COLOR,
	 cast('' as int) as article_Type,    
	 cast('' as varchar(100)) as Season_Name,    
	 cast('' as datetime) as PUR_BILL_DATE,    
	 cast('' as varchar(100)) as PUR_BILL_NO  ,
	 cast(0 as bit) as MRP_RESTRICTION,
     cast(0 as numeric(14,2)) MRP_RESTRICTION_FROM,
     cast(0 as numeric(14,2))  MRP_RESTRICTION_TO 
