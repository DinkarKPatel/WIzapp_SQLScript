CREATE PROCEDURE DBO.SP_MERGE_MIRROR_MSTSEASON
 ( @NMODE INT
  ,@XN_TYPE VARCHAR(50) ='MSTSEASON'
 )
AS
 BEGIN
...
BEGIN TRY
	  ...
	  BEGIN
			SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTSEASON, CANNOT CALL MERGING PROC AT HEAD OFFICE'
			GOTO END_PROC
  	  END					
	 ...
	 --INSERT DATA INTO LOCATION TABLE
	   ...
	   SET @CSTEP = 20
	   SET @CTABLENAME = 'SEASON_MST'
	   SET @CSOURCETABLE ='MSTSEASON_SEASON_MST_MIRROR'
	   SET @CKEYFIELD1 ='SEASON_NAME'
	   EXEC UPDATEMASTERXN
	   ...
	   SET @CSTEP = 30
	   ---EXECUTE THIS PROCEDURE AFTER UPDATE SEASON_MST
...
BEGIN CATCH
	SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTSEASON, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()
	GOTO END_PROC
END CATCH
...
END_PROC:
	...
	BEGIN   
	  ...
	  DELETE FROM MSTSEASON_SEASON_MST_MIRROR
...
END
--END PROCEDURE SP_MERGE_MIRROR_MSTSEASON
