...
EXEC USP_MILK_PURCHASE_FILTERS '2017-01-10','2017-01-13'
*/
CREATE PROCEDURE DBO.USP_MILK_PURCHASE_FILTERS
( @FROM_DATE DATETIME = ''
 ,@TO_DATE DATETIME = ''
)
----WITH ENCRYPTION
AS
 BEGIN
  ...
  WHERE (@TO_DATE='' OR @TO_DATE ='01-01-1900' 
          OR CAST(M.MEMO_DT AS DATETIME) BETWEEN CAST(@FROM_DATE AS DATETIME) AND CAST(@TO_DATE AS DATETIME))
