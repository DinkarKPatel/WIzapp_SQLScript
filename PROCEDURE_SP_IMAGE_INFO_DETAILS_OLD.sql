CREATE PROCEDURE DBO.SP_IMAGE_INFO_DETAILS_OLD
(
 @MRR_ID VARCHAR(100)
)
AS
 BEGIN
   --DECLARE LOCAL VARIABLE  
    ...
    ,PARA1_NAME	VARCHAR(200)
    ,PARA2_CODE	VARCHAR(200)
    ,PARA2_NAME	VARCHAR(200)
    ,PARA3_CODE	VARCHAR(200)
    ,PARA3_NAME	VARCHAR(200)
    ,PARA4_CODE	VARCHAR(200)
    ,PARA4_NAME	VARCHAR(200)
    ,PARA5_CODE	VARCHAR(200)
    ,PARA5_NAME	VARCHAR(200)
    ,PARA6_CODE	VARCHAR(200)
    ,PARA6_NAME	VARCHAR(200)
    ...
    BEGIN
     ...
     SET @DTSQLALTERTABLE = @DTSQLALTERTABLE+'PARA1_NAME VARCHAR(100), PARA1_CODE VARCHAR(50),'
    ...
    BEGIN
     ...
     SET @DTSQLALTERTABLE = @DTSQLALTERTABLE+'PARA2_NAME VARCHAR(100), PARA2_CODE VARCHAR(50),' 
    ...
    BEGIN
     ...
     SET @DTSQLALTERTABLE = @DTSQLALTERTABLE+'PARA3_NAME VARCHAR(100), PARA3_CODE VARCHAR(50),'  
    ...
    BEGIN
     ...
     SET @DTSQLALTERTABLE = @DTSQLALTERTABLE+'PARA4_NAME VARCHAR(100),PARA4_CODE VARCHAR(50),'   
    ...
    BEGIN
     ...
     SET @DTSQLALTERTABLE = @DTSQLALTERTABLE+'PARA5_NAME VARCHAR(100),PARA5_CODE VARCHAR(50),'  
    ...
    BEGIN
     ...
     SET @DTSQLALTERTABLE = @DTSQLALTERTABLE+'PARA6_NAME VARCHAR(100), PARA6_CODE VARCHAR(50),' 
