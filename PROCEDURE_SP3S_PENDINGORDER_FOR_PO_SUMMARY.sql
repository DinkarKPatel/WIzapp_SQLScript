create PROCEDURE SP3S_PENDINGORDER_FOR_PO_SUMMARY
(
	@CWHERE NVARCHAR(MAX),
	@DLOGINDT DATEtIME='',
	@cdept_id varchar(5)=''
...
BEGIN
	...
	BEGIN TRY
		...
		SET @CCMD=N'
		SELECT CONVERT(BIT,0) AS BCHK,ARTICLE_NO,ARTICLE_CODE,PARA1_CODE,PARA1_NAME,'+
		@CSIZE_SUM+','+@CSIZE_SUM_TOTAL +' AS TOTAL,CONVERT(NUMERIC(14,2),0) AS ORD_QTY
		FROM ##PENDINGORDER_PIVOT
		GROUP BY ARTICLE_NO,ARTICLE_CODE,PARA1_CODE,PARA1_NAME'
