CREATE PROCEDURE USP_GP_RETURN_PRINT
(
 @CMEMO_ID VARCHAR(50) = ''
)
AS
		  ...
		  AS [ADDRESS],[TRANSPOTER NAME], [MEMO_DT]
	       ...
	       (
	         SELECT 1 AS CHK,GPD.MEMO_ID,GPM.MEMO_NO,GPD.INV_ID
				  ...
				  ,GPM.REMARKS AS [REMARKS_MST],GPD.REMARKS AS [REMARKS_DET]
				  ,AGM.ANGADIA_ADD1,AGM.ANGADIA_ADD2,AR.AREA_NAME,CT.CITY
				  ,AGM.ANGADIA_NAME AS [TRANSPOTER NAME]
				  ,GPM.MEMO_DT AS [MEMO_DT]
			FROM DBO.TBL_GP_RETURN_MST GPM WITH(NOLOCK)
				JOIN DBO.TBL_GP_RETURN_DET GPD WITH(NOLOCK) ON GPM.MEMO_ID=GPD.MEMO_ID
			...
			GROUP BY GPD.MEMO_ID,GPD.INV_ID,GPD.REMARKS
				...
				,AGM.ANGADIA_ADD1,AGM.ANGADIA_ADD2,AR.AREA_NAME,CT.CITY
				,AGM.ANGADIA_NAME,GPM.MEMO_NO,GPM.MEMO_DT
