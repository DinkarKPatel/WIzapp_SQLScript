CREATE PROCEDURE SP_MERGE_MIRROR_XNSDTM_DATA
(
	@CMEMOID VARCHAR(50),  
    @CLOCID VARCHAR(2), 
...
BEGIN
	...
	BEGIN TRY 
			...
			INSERT @TXNSSENDINFO (ORG_TABLENAME) VALUES ('DTM') 

			SET @CSTEP = 20 
			SET @CTABLENAME='DTM'  
			SET @CTMP_TABLENAME='TMP_XNSDTM_'+@CTABLENAME+'_'+LTRIM(RTRIM(@CTABLE_SUFFIX))  
	...
	BEGIN CATCH
	 SET @CERRMSG='P:SP_MERGE_MIRROR_XNSDTM_DATA, STEP:'+LTRIM(RTRIM(STR(@CSTEP)))+', MESSAGE:'+ERROR_MESSAGE()
	END CATCH
