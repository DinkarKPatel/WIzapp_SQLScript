CREATE VIEW VW_CANCELUNCANCELLIST 

AS
SELECT   
A.CNC_MEMO_ID,  
A.CNC_MEMO_NO AS MST_MEMO_NO,  
A.CNC_MEMO_DT AS MST_XN_DT,  
A.CNC_TYPE AS MST_CNC_TYPE,  
A.REMARKS AS MST_REMARKS,  
A.TOTAL_AMOUNT AS CAL_TOTAL_AMOUNT,  
A.FIN_YEAR AS MST_FIN_YEAR,  
ICD.TOTQTY AS CAL_TOTAL_QUANTITY,  
B.QUANTITY AS 'CAL_QUANTITY',  
SKU.PURCHASE_PRICE * B.QUANTITY AS 'CAL_AMOUNT' ,
