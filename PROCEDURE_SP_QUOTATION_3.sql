CREATE PROCEDURE SP_QUOTATION_3  
@CWHERE   NVARCHAR(MAX)='',  
@CFINYEAR  VARCHAR(5)='',  
@CDEPTID  VARCHAR(4)='',  
...
begin
	...
	--	 sku.ARTICLE_NO,sku.ARTICLE_NAME, art.coding_scheme,  0 as PARA1_SET, 0 as PARA2_SET,'0000000' as UOM_CODE, 
	--	i.uom_name as UOM_NAME, 1 as UOM_TYPE,  
	--	 PARA1_NAME,PARA2_NAME,PARA3_NAME,PARA4_NAME, PARA5_NAME, PARA6_NAME, art.STOCK_NA,0 as GEN_EAN_CODES,    
	--	 '' AS JRD_ROW_ID, '' AS JID_ROW_ID, '' AS JOD_ROW_ID , 0 as PARA2_ORDER,
	--	 SD.SUB_SECTION_NAME,SM.SECTION_NAME,  '' AS [ART_DT_CREATED],'' AS [PARA3_DT_CREATED],        
	...
	--	FROM purchase_quotation_detail  A  (NOLOCK)   
	...
	--	LEFT OUTER JOIN art_names  sku   (NOLOCK) ON SKU.article_code=A.article_code
	...
	BEGIN
	   ...
	   ,art.PERISHABLE,'' as BATCH_NO, 
		...
		LEFT OUTER JOIN quotation_mst R  (NOLOCK) ON R.PQ_ID= A.PQ_ID     
