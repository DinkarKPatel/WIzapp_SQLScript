create PROCEDURE SP_GETDEBITNOTEPRINT  
@CRMID VARCHAR(40),  
...
BEGIN  
 ...
 SET @CCMD=N'SELECT  
   ...
   (B.ADDRESS0+B.ADDRESS1+B.ADDRESS2 )AS SUPPLIER_ADDRESS
	...
	----------------------
	,(''20''+RIGHT((A.FIN_YEAR -1),2)+''- 20''+ RIGHT(A.FIN_YEAR,2)) AS FIN_PRINT'
  ...
  SET @CCMD1=N'  FROM RMM01106 A (NOLOCK)               
   ...
   LEFT JOIN PIM01106 PIM ON PIM.MRR_ID=C.MRR_ID  
   LEFT JOIN LEDGER_TERMS LT ON 1=2
   -------- COMMENT AFTER DISCUSSTION  WITH PANAK.R SIR ON DATE 04-06-2016  
   ...
   (  
    ...
    ' FROM SKU JOIN RMD01106 C ON C.PRODUCT_CODE=SKU.PRODUCT_CODE 
      JOIN RMM01106 (NOLOCK) A ON A.RM_ID=C.RM_ID 
