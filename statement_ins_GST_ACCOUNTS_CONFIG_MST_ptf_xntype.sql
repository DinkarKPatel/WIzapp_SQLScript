IF NOT EXISTS (SELECT TOP 1 XN_TYPE FROM GST_ACCOUNTS_CONFIG_MST WHERE xn_type='PTF')
	...
	SELECT 1 AS SNO,'PTF' AS XN_TYPE,'PETTY CASH TRANSFER' AS DISPLAY_XN_TYPE,0 AS ENABLEPOSTING,'2017-06-30' ,0 AS POST_BILL_BY_BILL_REFTYPE,
...
update gst_accounts_config_mst set display_xn_type='TILL LIFT-LOCKER' where xn_type='tlf'
