CREATE PROCEDURE SAVETRAN_LOC_STOCK_LEVEL--(LocId 3 digit change by Sanjay:06-11-2024)
(
...
AS
BEGIN
  DECLARE @CMASTERTABLENAME VARCHAR(100),@CLOC_ID VARCHAR(4),
...
BEGIN TRY
		...
		BEGIN
			...
			SET @cCmd=N'SELECT TOP 1 @CLOC_ID=LOCATION_CODE FROM '+@CTEMPMASTERTABLE
