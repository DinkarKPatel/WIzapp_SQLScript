CREATE PROCEDURE SP3S_GET_BIN_FKEYDATA
...
BEGIN
	BEGIN TRY
		...
		SET @CFILTERCONDITION= 'B.BIN_ID IN (SELECT BIN_ID FROM '+@CTEMPTABLE+' )'
	...
	BEGIN CATCH
		SELECT @CERRORMSG='PROCEDURE SP3S_GET_BIN_FKEYDATA : '+ISNULL(ERROR_PROCEDURE(),'NULL P')+'STEP :'+STR(ISNULL(@NSTEP,0))+ ' LINE NO. :'+
...
END
----'END OF PROCEDURE SP3S_GET_BIN_FKEYDATA'
