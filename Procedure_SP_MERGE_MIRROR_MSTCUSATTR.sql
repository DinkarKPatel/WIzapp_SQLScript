create PROCEDURE SP_MERGE_MIRROR_MSTCUSATTR
(
  @NMODE INT,
  @XN_TYPE VARCHAR(50) ='MSTCUSATTR'
)
--WITH ENCRYPTION
AS
BEGIN
	...
	SET @CSTEP=20	
		...
		SET @CTMP_TABLENAME='MSTCUSATTR_'+@CTABLENAME+'_MIRROR'
	...
	END TRY
	BEGIN CATCH
		SET @CERRMSG='P:SP_MERGE_MIRROR_MSTCUSATTR, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()
	END CATCH
	...
	END
	SELECT @XN_TYPE AS MEMO_ID,@CERRMSG AS ERRMSG 
