CREATE PROCEDURE DBO.SP_MERGE_MIRROR_MSTLSP
 (@NMODE INT
  ,@XN_TYPE VARCHAR(50) ='MSTLSP'
  )
AS
 BEGIN
...
BEGIN TRY
	  ...
	  BEGIN
			SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTLSP, CANNOT CALL MERGING PROC AT HEAD OFFICE'
			GOTO END_PROC
  	  END					
	  ...
	  DELETE  FROM LOC_SPACE_DET
	  DELETE  FROM LOC_SPACE_MST 
	 ...
	 --INSERT DATA INTO LOCATION TABLE
	   ...
	   SET @CSTEP = 40
	   SET @CTABLENAME = 'LOC_SPACE_MST'
	   SET @CSOURCETABLE ='MSTLSP_LOC_SPACE_MST_MIRROR'
	   ...
	   --INSERT AND UPDATE DATA INTO LICENSE_INFO_HO TABLE
	   SET @CSTEP = 50
	   SET @CTABLENAME = 'LOC_SPACE_DET'
	   SET @CSOURCETABLE ='MSTLSP_LOC_SPACE_DET_MIRROR'
...
BEGIN CATCH
	SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTLSP, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()
	GOTO END_PROC
END CATCH
...
END_PROC:
	...
	BEGIN   
		  ...
		  DELETE FROM MSTLSP_LOC_SPACE_MST_MIRROR
		  DELETE FROM MSTLSP_LOC_SPACE_DET_MIRROR
	END
		
	SELECT @XN_TYPE AS MEMO_ID,@CERRORMSG AS ERRMSG   	  
END

--END PROCEDURE SP_MERGE_MIRROR_MSTLSP
