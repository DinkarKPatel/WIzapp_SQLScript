...
CREATE VIEW VW_XNSREPS_SERVICES    
AS    
 SELECT  A.DEPT_ID,    
   'OPS' AS XN_TYPE,     
   XN_DT,     
 ...
 WHERE B.CANCELLED = 0 AND E.ITEM_TYPE=4   
 ...
 WHERE B.CANCELLED = 0 AND XN_ITEM_TYPE=4
