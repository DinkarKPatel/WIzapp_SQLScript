...
IF NOT EXISTS (SELECT TOP 1 'U' FROM BIN WHERE BIN_ID='888')
BEGIN
	...
	'' BIN_ALIAS,'888' BIN_ID, 
	'GitBin' BIN_NAME,0 INACTIVE,GETDATE() LAST_UPDATE, 
	'888' MAJOR_BIN_ID,NULL MBO_COUNTER,'0000000000' MBO_LEDGER_AC_CODE, 
