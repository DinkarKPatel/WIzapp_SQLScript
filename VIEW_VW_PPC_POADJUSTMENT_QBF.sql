CREATE VIEW VW_PPC_POADJUSTMENT_QBF     
...
I.PARA1_NAME,I.PARA2_NAME,I.PARA3_NAME,   
I.SUB_SECTION_NAME,I.SECTION_NAME  
...
(    
	SELECT  DET.MEMO_ID,   
	A.QUANTITY AS PO_QTY,(A.QUANTITY-(ISNULL(PI.PUR_QTY,0)+ISNULL(P2.ADJ_QTY,0))) AS PENDING_QTY,  
	...
	LEFT OUTER JOIN PPC_POM01106 R ON R.PO_ID= A.PO_ID     
	...
	PPC_PID01106 A JOIN PIM01106 B ON A.MRR_ID=B.MRR_ID    
	WHERE CANCELLED=0     
	GROUP BY PO_ROW_ID    
