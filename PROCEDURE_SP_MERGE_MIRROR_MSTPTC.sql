CREATE PROCEDURE DBO.SP_MERGE_MIRROR_MSTPTC
  ( @NMODE INT
  ,@XN_TYPE VARCHAR(50) ='MSTPTC'
  )
AS
 BEGIN
...
BEGIN TRY
	  ...
	  BEGIN
			SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTPTC, CANNOT CALL MERGING PROC AT HEAD OFFICE'
			GOTO END_PROC
  	  END					
	 ...
	 --INSERT DATA INTO LOCATION TABLE
	   ...
	   SET @CSOURCETABLE ='MSTPTC_LM01106_MIRROR'
	   ...
	   SET @CSOURCETABLE ='MSTPTC_PETTY_CASH_AC_MIRROR'
...
BEGIN CATCH
	SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTPTC, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()
	GOTO END_PROC
END CATCH
...
END_PROC:
	...
	BEGIN   
	    ...
	    DELETE FROM MSTPTC_LM01106_MIRROR
		DELETE FROM MSTPTC_PETTY_CASH_AC_MIRROR
...
--END PROCEDURE SP_MERGE_MIRROR_MSTPTC
