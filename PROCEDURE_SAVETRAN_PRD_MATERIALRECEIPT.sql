CREATE PROCEDURE SAVETRAN_PRD_MATERIALRECEIPT
(
...
BEGIN
	...
	SET @CDETAILTABLENAME1	= 'PRD_MATERIAL_RECEIPT_DET'
	...
	BEGIN TRY
		...
		IF @NUPDATEMODE = 3
		BEGIN
			EXEC SAVETRAN_CANCELXN 'MRC',@CDETAILTABLENAME1,@CXNMEMOID,@CKEYFIELD1,@CMASTERTABLENAME,@CLOCATIONID,
...
END_PROC:
	...
	EXEC SP_DROPTEMPTABLES_XNS 'XNSMRC',@NSPID		
END			
------------------------------------------------------ END OF PROCEDURE SAVETRAN_PRD_MATERIALRECEIPT
