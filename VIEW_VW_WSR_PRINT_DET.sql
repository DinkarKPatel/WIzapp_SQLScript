CREATE VIEW VW_WSR_PRINT_DET

AS
	SELECT   A.QUANTITY,A.ITEM_TAX_PERCENTAGE AS TAX_PERCENTAGE,A.ITEM_TAX_AMOUNT AS TAX_AMOUNT,A.CN_ID,RMM.FIN_YEAR,A.RFNET,A.RFNET_WOTAX,
	A.LOCAL_TAX_STATUS
	,A.RATE,A.CN_TAX_METHOD,A.DISCOUNT_PERCENTAGE,A.DISCOUNT_AMOUNT,A.NET_RATE,0 AS OH_AMOUNT,A.RATE_PER_CONV_UOM
	,A.CUSTOM_DUTY_PER,A.CUSTOM_DUTY_AMT,A.CVD_PER,A.EDU_CESS_CVD,A.H_EDU_CESS_CVD,A.CVD_AMT,A.EDU_CESS_CUSTOM
	,A.TOTAL_CUSTOM_DUTY_AMT,A.H_EDU_CESS_CUSTOM,A.EMP_CODE,A.EXCISE_MRP,
...
AT25.ATTR25_KEY_NAME 
	FROM CND01106 A    
    JOIN CNM01106 RMM ON A.CN_ID = RMM.CN_ID 
