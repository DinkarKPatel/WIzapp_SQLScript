CREATE PROCEDURE DBO.SP_MERGE_MIRROR_MSTLREQ
 (@NMODE INT
  ,@XN_TYPE VARCHAR(50) ='MSTLREQ'
  )
AS
 BEGIN
...
BEGIN TRY
	  ...
	  BEGIN
			SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTLREQ, CANNOT CALL MERGING PROC AT HEAD OFFICE'
			GOTO END_PROC
  	  END					
	 ...
	 --INSERT DATA INTO LOCATION TABLE
	   ...
	   SET @CSOURCETABLE ='MSTLREQ_LOC_REQ_MIRROR'
...
BEGIN CATCH
	SET @CERRORMSG='P:SP_MERGE_MIRROR_MSTLREQ, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()
	GOTO END_PROC
END CATCH
...
END_PROC:
	...
	BEGIN   
	   ...
	   DELETE FROM MSTLREQ_LOC_REQ_MIRROR
...
--END PROCEDURE SP_MERGE_MIRROR_MSTLREQ
