create PROCEDURE SP3S_SYNCH_UPLOADDATA_JWR_OPT
(
    @CSPID VARCHAR(50)
...
BEGIN TRY
	...
	SELECT @CTEMPMASTERTABLE=@CSOURCEDB+'JWR_JOBWORK_RECEIPT_MST_UPLOAD',
		   ...
		   @CTEMPDETAILTABLE1=@CSOURCEDB+'JWR_PMT01106_UPLOAD'
...
LBLSTART:
    ...
    SELECT TOP 1 @CMEMOID = B.RECEIPT_ID ,@bCancelled=cancelled 
	...
	BEGIN
		...
		SELECT @CFINYEAR=FIN_YEAR FROM JWR_JOBWORK_RECEIPT_MST_UPLOAD (NOLOCK) WHERE RECEIPT_ID=@CMEMOID
...
LBLMERGE:
	...
	@cTempTable='JWR_PMT01106_upload',  
	@cMemoIdCol='SP_ID',  
	@cMemoId =@CSPID
		...
		DELETE A FROM JWR_PMT01106_UPLOAD A WHERE A.SP_ID=@CSPID
...
BEGIN CATCH
	SET @CERRMSG='P:SP3S_SYNCH_UPLOADDATA_JWR_OPT, STEP:'+@CSTEP+', MESSAGE:'+ERROR_MESSAGE()
	GOTO EXIT_PROC
END CATCH
