CREATE PROCEDURE SP_BUYERSORDER_WSL_SIZESET_EDITMODE
@cSpiD  varchar(50)
...
IF OBJECT_ID('TEMPDB..#TMPBO','U') IS NOT NULL
        ...
        SELECT '' as AC_CODE, B.ARTICLE_NAME,  
		0 AS SERIAL_NO,    
		B.ARTICLE_NO,C.PARA1_NAME,D.PARA2_SET AS PARA2_NAME,0 as PARA2_ORDER,C.PARA1_ORDER ,  E.PARA3_NAME,
		...
		A.PARA3_CODE,A.PARA4_CODE ,A.PARA5_CODE ,A.PARA6_CODE ,0 AS SR_NO,B.para2_set,'0000000' AS Para2_code,
		A.manual_rate,(FROM_UOM_NAME+ ' - ' +TO_UOM_NAME) AS AREA_UOM_NAME,
			...
			area_length,area_width,area_sqare,area_rate_pp,
			RATE_AREA_SQUARE,area_uom_code,A.AutoRate
	    INTO #TMPBO
		...
		WHERE A.sp_id = @cSpiD and isnull(A.article_code,'') <> '' 
		GROUP BY  B.ARTICLE_NAME,    
		B.ARTICLE_NO,C.PARA1_NAME,C.PARA1_ORDER ,  E.PARA3_NAME,
		B.UOM_CODE,UOM.UOM_NAME,UOM.UOM_TYPE,B.DT_CREATED,  
		B.CODING_SCHEME,B.PARA1_SET,D.PARA2_SET, B.ALIAS ,
		...
		A.PARA3_CODE,A.PARA4_CODE ,A.PARA5_CODE ,A.PARA6_CODE,B.para2_set,
		A.manual_rate,A.manual_rate,(FROM_UOM_NAME+ ' - ' +TO_UOM_NAME) ,
			ISNULL(AR_UOM.SQUARE_UNIT,0) ,			ISNULL(AR_UOM.BASE_UNIT,0) ,
			ISNULL(AR_UOM.FROM_UOM_NAME,'''') ,			ISNULL(AR_UOM.TO_UOM_NAME,'''') ,
			  area_length,area_width,area_sqare,area_rate_pp,
			  RATE_AREA_SQUARE,area_uom_code,A.AutoRate
	...
	,ISNULL(A20.ATTR20_KEY_NAME,'')  ATTR20_KEY_NAME  ,ISNULL(A21.ATTR21_KEY_NAME,'') ATTR21_KEY_NAME
	 ...
	 ,Angadia_name,fc_name,A.Angadia_code,fc_code,
	 item_delivery_dt,A.para2_set, Para2_code,po_qty,A.manual_rate,pi_qty,
