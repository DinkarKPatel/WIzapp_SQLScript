create PROCEDURE ACT_LEDGERDAILY_NEW 
(	
		@CACCODE VARCHAR(20), 
		@CDEPTID VARCHAR(4), 
		@DFROMDT DATETIME, 
...
BEGIN
	DECLARE @CTMPACCODE VARCHAR(20), 
			...
			@NCLOSING NUMERIC(14,2),@CDONOT_CONSIDER_MEMO_VOUCHERS_ACCBOOKS VARCHAR(2),
	...
	BEGIN
		...
		SELECT @NOPENING = DBO.FN_ACT_OPENING_new( @CTMPACCODE, @CDEPTID, @DFROMDT, @CFINYEAR, @CCOMPANYCODE )
