...
create PROCEDURE SP_PRODUCT_STATUS_REPORT_8
(
 @nQueryID	INT,  
 @DFM_DT DATETIME='',  
 @DTO_DT DATETIME='',  
...
BEGIN
	   ...
	   A.PARA1_NAME,A.PARA1_CODE,A.BRAND,a.MEMO_ID ,A.ORDER_ID 
	   ...
	   begin
		 ...
		 SET @DTSQL=N'SELECT A.DEPT_ID as [Location Name], A.BUYER_NAME as [Party] ,A.ORDER_NO as [Order No] ,  
		   ...
		   (  
			...
			SELECT MEMO_ID,ARTICLE_CODE,PARA1_CODE,'+@CCOLUMN_NAME+'  
			FROM  
			(  
			 SELECT A.MEMO_ID,A.ARTICLE_CODE,A.PARA1_CODE,  
					JOBWORK_NAME,  
			 ...
			 GROUP BY A.MEMO_ID,A.ARTICLE_CODE,A.PARA1_CODE,  
			 ...
			 GROUP BY MEMO_ID,ARTICLE_CODE,PARA1_CODE  
		   ...
		   (  
			...
			GROUP BY A.MEMO_ID,A.ARTICLE_CODE,A.PARA1_CODE  
		   ) TTM ON A.ARTICLE_CODE=TTM.ARTICLE_CODE AND A.PARA1_CODE=TTM.PARA1_CODE   
		   AND A.MEMO_ID=TTM.MEMO_ID  
		   order by A.JOBCARD_NO ,A.JOBCARD_DT ,  
				  A.ARTICLE_NO,A.PARA1_NAME  '  
		   PRINT @DTSQL  
		   EXEC (@DTSQL)  
