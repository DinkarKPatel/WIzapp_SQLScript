CREATE PROCEDURE SAVETRAN_REC_SAMPLE
(
...
BEGIN
	...
	SET @CMASTERTABLENAME	= 'PRD_AGENCY_MATERIAL_RECEIPT_MST_SAMPLE'
	SET @CDETAILTABLENAME1	= 'PRD_AGENCY_MATERIAL_RECEIPT_DET_SAMPLE'
	...
	BEGIN TRY
		...
		SET @CCMD=N' UPDATE '+@CMASTERTABLENAME+' SET CANCELLED=1,LAST_UPDATE=GETDATE() WHERE '+@CKEYFIELD1+'='''+@CMEMOID+''''
