CREATE VIEW VW_WSL_PRINT_DET

AS
	SELECT  A.INV_ID,A.QUANTITY,A.RATE,A.DISCOUNT_PERCENTAGE,A.DISCOUNT_AMOUNT,A.DEPT_ID,A.ROW_ID,A.RFNET
	,A.RFNET_WOTAX,A.NET_RATE,A.EMP_CODE,A.BOX_NO,
...
AT25.ATTR25_KEY_NAME 
    FROM IND01106 A    
    JOIN INM01106 INM ON A.INV_ID = INM.INV_ID 
    --JOIN ITV01106 C ON C.PRODUCT_CODE=A.PRODUCT_CODE --- OPTIMIZATION AFTER REMOVING VIEWS
